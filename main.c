...
/* USER CODE BEGIN PV */
//variables allowing comprehension between Model-Presenter-View
volatile uint8_t LEDs = 0;
volatile uint8_t LED_TFT = 0;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_5|GPIO_PIN_3|RENDER_TIME_Pin, GPIO_PIN_RESET);
